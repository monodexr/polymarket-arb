...
# Binance WS uses AWS Tokyo (stream.binance.com resolves to AWS ap-northeast-1).
# Binance.com geo-blocks US IPs (451), so route through VPN too.
# AWS Tokyo IP ranges that cover Binance endpoints:
BINANCE_CIDRS="3.112.0.0/14, 13.112.0.0/14, 35.72.0.0/13, 54.238.0.0/16, 52.68.0.0/15, 18.176.0.0/13"
